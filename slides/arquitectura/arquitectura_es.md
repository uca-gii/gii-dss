...
## Introducción a arquitecturas software
...
### La arquitectura se aplica a varias **disciplines**
...
Ambos son desarrollados por equipos que usan **herramientas**, **patrones** y **tácticas** y son afectados por **tendencias**
...
Los edificios son entornos **estables** con límites **físicos** and many difficulties to change, el software es un artefacto **virtual** con naturaleza evolutiva y es más fácil de **cambiar**
...
### La arquitectura de a **software system**
...
- Major **decisions** have to do with **technology** choices, selection of the proper **infrastructure**, application of certain **tactics** and design **patrones**, etc

---

### Arquitectura evolutiva (II)
...
- What are the interesados' **expectations**?
...
### Expectativas de un Arquitecto (Software)
...
- Good **interpersonal skills** to deal with interesados who may have different (even contradictory) needs
- Solid knowledge of the **business domain**.
- Aware of **new** development techniques, practices, and tools.
- **Self-experience** for correctly applying best practices, design principles, and patrones.
...
**Documenting** software architectures helps us understand the **big picture** of the systems, providing a **shared** vision and a common **vocabulary** for all interesados.
...
- Which **tactics**, **principles**, and **patrones** have been used?
...
#### Examples of decisions on **patrones/styles**
...
## Frameworks para crear arquitecturas
...
## Arquitectura software como código
