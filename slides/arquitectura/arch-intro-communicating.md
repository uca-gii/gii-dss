...
<emph>Introduction to software architectures</emph>
<emph>Communicating architectures</emph>
...
<emph>1. Everything in software architecture is a trade off</emph>
(All meaningful decisions have advantages and downsides)

<emph>2. 'Why' is more important than 'How'</emph>
(Question everything)

<emph>3. Most architecture decisions aren’t binary but rather exist on a spectrum between extremes.</emph>

![bg left:45% 130%](./img/ArchitectureDesignProcess.png)
...
![C4 model logo w:350](./img/c4model.png)
