...
![Background image](./img/SydneyOperaHouse.jpg)
...
![Background image](./img/Naval.png)
...
> _Fundamental organization embodied in its **components** and their **relationships** to each other and their environment. The **principles** of its design and evolution._
>
...
> _A **system architecture** makes use of elements of both **software** and **hardware** and is used to enable the design of such a composite system._
>
> — *ISO/IEC/IEEE 42010*
...
> _It is the shape given to that system by those who build it. The form of that shape is in the division of that system into **components**, the **arrangement** of those components, and the ways in which those components **communicate** with each other._
>
> — Robert C. Martin
...
> _The **set of significant decisions** about the **organization of a software system**, the selection of the **structural elements and their interfaces** ...together with their **behavior** ..., the **composition** of these ... elements ..., and the **architectural style**._
>
> — Kruchten: The Rational Unified Process

> _Architecture represents the **significant decisions**, where significance is measured by **cost of change**._
>
> — Grady Booch
...
![Background image](./img/Scrum.png)
...
> _Big design up front is dumb._
> _Doing no design up front is even dumber._
>
> – Dave Thomas
...
![Background image](./img/ArchitectureDesignProcess.png)
...
![Background image](./img/UML_UseCase.png)
...
![Background image](./img/UML_DomainModel.png)
...
![Background image](./img/SysML_Requirements.png)
...
![Background image](./img/architect_role.png)
...
![Background image](./img/Sketch.jpg)


<div class="cols">
<div>

![Sample architecture diagram](./img/SampleArchitecture.png)
...
![Background image](./img/Modelio.png)
...
![PlantUML screenshot](./img/PlantUML.png)
...
![Background image](./img/UML_Diagrams.jpeg)
...
![Background image](./img/C4_Abstractions.png)
...
![Background image](./img/C4_SystemContext.png)
...
![Background image](./img/C4_Containers.png)
...
> _A software component is a **unit of composition with contractually specified interfaces and explicit context dependencies**. A software component can be **deployed independently** and is subject to **third-party composition**._
> — Clemens Szyperski

> _Software components are libraries, i.e., **things that are independently replaceable and upgradeable**. Examples: Java's jars, C#'s assemblies, Ruby's gems, and Javascript's modules._
> — Martin Fowler


#### Example of a Component diagram  (Jar files)

![Background image](./img/JAR_Components.png)
...
> _A component is a **grouping of related functionality (classes) encapsulated behind a well-defined interface**._
> _Aspects such as how those components are organized (packages, modules, JAR file, DLL, namespaces, shared library, etc) is a separate and orthogonal concern. In the C4 model, components are not separately deployable units._
>
...
![Background image](./img/C4_Components_Modified.png)
...
![Background image](./img/UML_Components.png)
...
![Background image](./img/C4_Code.png)
...
![Background image](./img/C4_Landscape.png)
...
![Background image](./img/C4_Dynamic.png)
...
![Background image](./img/C4_Deployment.png)
...
![Background image](./img/Structurizr.png)
...
![](./img/Style_PortsAdapters.png)

![](./img/Style_Clean_DSS.png)
...
![](./img/Style_ClientServerNTier.png)
